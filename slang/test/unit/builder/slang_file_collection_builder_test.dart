...
void main() {
  ...
  test('should detect wildcard locales', () {
    final model = SlangFileCollectionBuilder.fromFileModel(
      config: RawConfig.defaultConfig,
      files: [
        _file('lib/i18n/en.i18n.json'),
        _file('lib/i18n/de.i18n.json'),
        _file('lib/i18n/[en,de]-DE.i18n.json'),
        _file('lib/i18n/[any].i18n.json'),
      ],
    );
    ...
    expect(model.files, [
      isTranslationFile(
        path: 'lib/i18n/[any].i18n.json',
        locale: '[any]',
        languageIsWildcard: true,
        namespace: '_default',
      ),
      isTranslationFile(
        path: 'lib/i18n/de.i18n.json',
      ...
      isTranslationFile(
        path: 'lib/i18n/[en,de]-DE.i18n.json',
        locale: '[en,de]-DE',
        languageIsWildcard: true,
        namespace: '_default',
      ),
...
TypeMatcher<TranslationFile> isTranslationFile({
  ...
  bool languageIsWildcard = false,
}) {
  final parsedLocale = I18nLocale.fromString(locale);
  return isA<TranslationFile>()
      .having((f) => f.path, 'path', path)
      .having((f) => f.locale, 'locale', parsedLocale)
      .having((f) => f.namespace, 'namespace', namespace)
      .having(
        (f) => f.locale.languageIsWildcard,
        'languageIsWildcard',
        languageIsWildcard,
      );
}
