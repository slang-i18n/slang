...
Builder i18nLegacyBuilder(BuilderOptions options) {
  return I18nLegacyBuilder(
    config: RawConfigBuilder.fromMap(MapUtils.deepCast(options.config))
      ..validate(),
  );
}

class I18nLegacyBuilder implements Builder {
  final RawConfig config;
  final String outputFilePattern;
  bool _generated = false;

  I18nLegacyBuilder({required this.config})
...
extension _LegacyBuilderStringExt on String {
