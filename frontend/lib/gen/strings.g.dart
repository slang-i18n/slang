...
///
/// Built on 2023-07-26 at 19:31 UTC
...
class StringsEn implements BaseTranslations<AppLocale, StringsEn> {
	...
	// Translations
	String get frontend => 'Frontend English';
}
...
class StringsDe implements StringsEn {
	...
	// Translations
	@override String get frontend => 'Frontend Deutsch';
}
...
extension on StringsEn {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'frontend': return 'Frontend English';
			default: return null;
		}
	}
}
...
extension on StringsDe {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'frontend': return 'Frontend Deutsch';
			default: return null;
		}
	}
}
